...
const botName = "Ronin";
const botLocation = "Nagpur";
const favoriteLanguage = "HTML, CSS, JS";

console.log(`My name is ${botName} and I live on ${botLocation}.`);
console.log(`My favorite programming language is ${favoriteLanguage}.`)

let codingFact = `${favoriteLanguage} is complete in 30 days.`;
console.log(codingFact)

codingFact = `${favoriteLanguage} it very easy language.`;
console.log(codingFact);

codingFact = `${favoriteLanguage} is one of the most popular language for web development .`;
console.log(codingFact);
